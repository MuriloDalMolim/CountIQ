        ...
        try {
            ...
            if (!req.isAdmin) {
                return res
                    .status(403)
                    .json({
                        error: 'Acesso negado. Apenas usuários ADMIN podem visualizar o cadastro de outros usuários',
                    });
            }
        ...
        try {
            ...
            if (!req.isAdmin) {
                return res
                    .status(403)
                    .json({
                        error: 'Acesso negado. Apenas usuários ADMIN podem realizar o cadastro de outros usuários',
                    });
            }
            ...
            if (!email || !password || !name) {
                return res
                    .status(400)
                    .json({
                        error: 'Email, senha e nome são obrigatórios para o cadastro.',
                    });
            }
        ...
        try {
            ...
            if (!req.isAdmin) {
                return res
                    .status(403)
                    .json({
                        error: 'Acesso negado. Apenas usuários ADMIN podem alterar campos de usuários',
                    });
            }
