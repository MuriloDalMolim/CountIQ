    ...
    async getListProducts(req: Request, res: Response) {
        try {
            ...
            if (!listId) {
                return res
                    .status(401)
                    .json({ error: 'Por favor, informe a lista desejada' });
            }
            ...
            return res
                .status(500)
                .json({ error: 'Erro ao buscar produtos da lista.' });
        }
    },

    async insertIntoList(req: Request, res: Response) {
        try {
            const listId = Number(req.params.listId);
            ...
            return res
                .status(500)
                .json({ error: 'Erro ao adicionar produto na lista.' });
        }
    },

    async deleteFromList(req: Request, res: Response) {
        try {
            const listId = Number(req.params.listId);
            ...
            if (!productId) {
                return res
                    .status(400)
                    .json({
                        error: 'Nenhum produto foi selecionado para remover.',
                    });
            }
            ...
            return res
                .status(500)
                .json({ error: 'Erro ao remover produto da lista.' });
        }
    },
};
