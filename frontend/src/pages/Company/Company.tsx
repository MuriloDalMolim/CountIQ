                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-xs text-gray-400 mt-2 italic">
                                    O CNPJ não pode ser alterado através desta
                                    interface.
                                </p>
                            </div>
                        </div>
                ...
                {isEditing && (
                    <div className="p-8 pt-4 flex flex-col md:flex-row gap-4 border-t border-gray-50">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={saving}
                            className="flex-1 flex items-center justify-center gap-2 py-4 bg-brand-500 text-white rounded-2xl font-bold hover:bg-[#7d360f] transition-all shadow-lg shadow-orange-100 disabled:opacity-50"
                        >
                            {saving ? (
                ...
                <div className="mt-8 p-6 bg-blue-50 border border-blue-100 rounded-[24px] flex gap-4 items-start text-blue-700">
                    ...
                    <div>
                        ...
                        <p className="text-sm opacity-80">
                            Estes dados são partilhados por todos os
                            utilizadores desta empresa no sistema.
                        </p>
                    </div>
                </div>
            )}
