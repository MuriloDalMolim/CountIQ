...
export function ViewProductsModal({
    isOpen,
    onClose,
    list,
    ...
    return (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/60">
            <div className="bg-white w-full max-w-3xl rounded-3xl shadow-2xl overflow-hidden flex flex-col h-[70vh] border-none">
                ...
                <div className="px-4 md:px-8 py-4 border-b border-gray-50 shrink-0">
                    {' '}
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            {filteredProducts.map((p) => (
                                <div
                                    key={p.productId}
                                    className="p-4 bg-gray-50 border border-gray-100 rounded-2xl flex justify-between items-center transition-none"
                                >
